  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 flex">
      ...
      <motion.button
        ...
        className="fixed top-4 left-4 z-50 lg:hidden bg-white/20 backdrop-blur-lg rounded-full p-3 border border-white/20 hover:bg-white/30 transition-all"
      >
        ...
        {isLeaderboardOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-0 left-0 w-full bg-gradient-to-br from-purple-600/95 via-pink-500/95 to-orange-400/95 backdrop-blur-lg z-50 lg:hidden overflow-y-auto"
            >
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button
                    onClick={() => setIsLeaderboardOpen(false)}
                    className="bg-white/20 backdrop-blur-sm rounded-full p-2 border border-white/20 hover:bg-white/30 transition-all"
                  >
                    <X className="w-6 h-6 text-white" />
                  </button>
                </div>
                <p className="text-white/70 text-sm mb-6">Top commit contributors</p>
                ...
                >
                  <p className="text-white/60 text-xs text-center">
                    Tap on any user to generate their music
                  </p>
                </motion.div>
              </div>
            </motion.div>
